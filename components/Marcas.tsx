...
export default function Marcas() {
  ...
  return (
    <Reveal id="marcas" className="overflow-hidden bg-elevated py-16 md:py-[100px]">
        ...
        <div className="marquee-track flex w-max">
          {logosX2.map((logo, i) => (
            <a
              ...
              target="_blank"
              rel="noopener"
              className="mr-4 flex h-[80px] w-[130px] flex-none items-center justify-center rounded-2xl bg-white px-4 text-center font-heading text-sm font-bold text-[#0D0D0D] transition-transform duration-200 ease-out hover:scale-[1.06] md:h-[100px] md:w-[170px] md:text-base"
            >
              {logo.name}
            </a>
          ))}
